 ...
 */
public class ArithGreaterThanEqualPredicate extends GroundLiteral
{
    public ArithGreaterThanEqualPredicate( Database database )
    {
        this( database, ">=", 2 );
    }

    public ArithGreaterThanEqualPredicate( Database database, String name, int arity )
    {
