 ...
 * /home/cvs/cvs/java-prolog/src/engine/uk/co/williams_technologies/prolog/builtin/arithmetic/SinFunction.java,v
 * 1.3 2004/05/05 05:28:38 simon Exp $
 * ******************************************************************************
 * $Log: SinFunction.java,v $ Revision 1.3 2004/05/05 05:28:38 simon Lots of
...
{
    public SinFunction( String name, int arity )
    {
        super( name, arity );
    }
