 ...
 * /home/cvs/cvs/java-prolog/src/engine/uk/co/williams_technologies/prolog/builtin/arithmetic/IntegerQuotientFunction.java,v
 * 1.3 2004/05/05 05:28:38 simon Exp $
 * ******************************************************************************
 * $Log: IntegerQuotientFunction.java,v $ Revision 1.3 2004/05/05 05:28:38 simon
...
public class IntegerQuotientFunction extends Function
{
    public IntegerQuotientFunction( String name, int arity )
    {
        super( name, arity );
    }
