 ...
 * /home/cvs/cvs/java-prolog/src/engine/uk/co/williams_technologies/prolog/builtin/arithmetic/QuotientFunction.java,v
 * 1.3 2004/05/05 05:28:38 simon Exp $
 * ******************************************************************************
 * $Log: QuotientFunction.java,v $ Revision 1.3 2004/05/05 05:28:38 simon Lots
...
public class QuotientFunction extends Function
{
    public QuotientFunction( String name, int arity )
    {
        super( name, arity );
    }
    ...
    public NumericConstant evaluate( Stack<NumericConstant> values )
    {
        ...
        if( right.isReal() || left.isReal() )
            return new NumericConstant( left.doubleValue()
                    / right.doubleValue() );
        else
