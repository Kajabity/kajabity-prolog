 ...
 * /home/cvs/cvs/java-prolog/src/engine/uk/co/williams_technologies/prolog/builtin/arithmetic/IntegerProductFunction.java,v
 * 1.3 2004/05/05 05:28:38 simon Exp $
 * ******************************************************************************
 * $Log: IntegerProductFunction.java,v $ Revision 1.3 2004/05/05 05:28:38 simon
...
public class IntegerProductFunction extends Function
{
    public IntegerProductFunction( String name, int arity )
    {
        super( name, arity );
    }
