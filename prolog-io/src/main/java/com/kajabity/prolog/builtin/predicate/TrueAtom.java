 ...
 * @author Simon
 */
public class TrueAtom extends GroundLiteral
{
    public TrueAtom( Database database )
    {
        this( database, "true", 0 );
    }

    public TrueAtom( Database database, String name, int arity )
    {
