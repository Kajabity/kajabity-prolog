 ...
 *
 *  $Header: /home/cvs/cvs/java-prolog/src/engine/uk/co/williams_technologies/prolog/builtin/predicate/FailAtom.java,v 1.1 2004/01/25 05:48:12 simon Exp $
 *******************************************************************************
 *  $Log: FailAtom.java,v $
 ...
 *
 *  Revision 1.4  2003/11/20 05:14:28  simon
 ...
 * @author Simon
 */
public class FailAtom extends GroundLiteral
{
    public FailAtom( Database database )
    {
        this( database, "fail", 0 );
    }

    public FailAtom( Database database, String name, int arity )
    {
