 ...
 */
public class ArithEqualPredicate extends GroundLiteral
{
    public ArithEqualPredicate( Database database )
    {
        this( database, "=:=", 2 );
    }

    public ArithEqualPredicate( Database database, String name, int arity )
    {
