 ...
 * /home/cvs/cvs/java-prolog/src/engine/uk/co/williams_technologies/prolog/builtin/arithmetic/IntegerSumFunction.java,v
 * 1.3 2004/05/05 05:28:38 simon Exp $
 * ******************************************************************************
 * $Log: IntegerSumFunction.java,v $ Revision 1.3 2004/05/05 05:28:38 simon Lots
...
public class IntegerSumFunction extends Function
{
    public IntegerSumFunction( String name, int arity )
    {
        super( name, arity );
    }
