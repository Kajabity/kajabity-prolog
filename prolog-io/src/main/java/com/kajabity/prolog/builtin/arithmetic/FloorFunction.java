 ...
 * /home/cvs/cvs/java-prolog/src/engine/uk/co/williams_technologies/prolog/builtin/arithmetic/FloorFunction.java,v
 * 1.3 2004/05/05 05:28:38 simon Exp $
 * ******************************************************************************
 * $Log: FloorFunction.java,v $ Revision 1.3 2004/05/05 05:28:38 simon Lots of
...
{
    public FloorFunction( String name, int arity )
    {
        super( name, arity );
    }
    ...
    public NumericConstant evaluate( Stack<NumericConstant> values )
    {
        ...
        if( right.isReal() )
            return new NumericConstant( Math.floor( right.doubleValue() ) );
        else
            return new NumericConstant( Math.floor( right.longValue() ) );
    }
}
