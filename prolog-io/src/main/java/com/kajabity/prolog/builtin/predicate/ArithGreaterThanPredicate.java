 ...
 */
public class ArithGreaterThanPredicate extends GroundLiteral
{
    public ArithGreaterThanPredicate( Database database )
    {
        this( database, ">", 2 );
    }

    public ArithGreaterThanPredicate( Database database, String name, int arity )
    {
