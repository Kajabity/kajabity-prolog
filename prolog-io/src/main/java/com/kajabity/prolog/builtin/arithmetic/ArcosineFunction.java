 ...
 * /home/cvs/cvs/java-prolog/src/engine/uk/co/williams_technologies/prolog/builtin/arithmetic/ArcosineFunction.java,v
 * 1.3 2004/05/05 05:28:38 simon Exp $
 * ******************************************************************************
 * $Log: ArcosineFunction.java,v $ Revision 1.3 2004/05/05 05:28:38 simon Lots
...
public class ArcosineFunction extends Function
{
    public ArcosineFunction( String name, int arity )
    {
        super( name, arity );
    }
    ...
    public NumericConstant evaluate( Stack<NumericConstant> values )
    {
        ...
        return new NumericConstant( Math.acos( right.doubleValue() ) );
    }
}
