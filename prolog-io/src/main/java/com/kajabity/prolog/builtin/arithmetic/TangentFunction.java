 ...
 * /home/cvs/cvs/java-prolog/src/engine/uk/co/williams_technologies/prolog/builtin/arithmetic/TangentFunction.java,v
 * 1.3 2004/05/05 05:28:38 simon Exp $
 * ******************************************************************************
 * $Log: TangentFunction.java,v $ Revision 1.3 2004/05/05 05:28:38 simon Lots of
...
{
    public TangentFunction( String name, int arity )
    {
        super( name, arity );
    }
    ...
    public NumericConstant evaluate( Stack<NumericConstant> values )
    {
        ...
        return new NumericConstant( Math.tan( right.doubleValue() ) );
    }
}
