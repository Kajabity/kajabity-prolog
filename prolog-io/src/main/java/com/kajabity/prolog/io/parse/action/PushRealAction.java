...
public class PushRealAction extends Action
{
    public void act( PrologParser parser ) throws PrologException
    {
        String value = parser.getHeldToken() + "." + parser.getTokeniser().toString();
        parser.pushValue( new NumericConstant( Double.parseDouble( value ) ) );
    }
}
