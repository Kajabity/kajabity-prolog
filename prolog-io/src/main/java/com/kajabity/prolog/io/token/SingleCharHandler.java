 ...
 *  Project     :   Java Prolog
 *
 *  $Header: /home/cvs/cvs/Prolog/IO/src/uk/co/williams_technologies/prolog/token/SingleCharHandler.java,v 1.1.1.1 2004/05/05 05:19:26 simon Exp $
 *******************************************************************************
 *  $Log: SingleCharHandler.java,v $
...
public class SingleCharHandler
    extends Handler
{
    private int type;

    public SingleCharHandler( int type )
    {
        this.type = type;
    }
