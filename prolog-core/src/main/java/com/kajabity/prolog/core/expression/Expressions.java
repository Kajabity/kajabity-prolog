...
public class Expressions {
     ...
     *
     * @param substitutions a List of Variables to be uninstantiated.
     */
     ...
     *
     * @param expr1 is a Term or List of Terms
     * @param expr2 is a Term or List of Terms.
    ...
    public static List<Variable> unify(Expression expr1, Expression expr2) {
        logger.trace("unify <<" + expr1 + ">> and <<" + expr2 + ">>");
        ...
        do {
            ...
            logger.trace("\tcomparing <<" + left + ">> and <<" + right + ">>");
