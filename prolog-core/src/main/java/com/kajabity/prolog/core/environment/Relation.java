 ...
 *
 *  $Header: /home/cvs/cvs/Prolog/Environment/src/uk/co/williams_technologies/prolog/environment/Relation.java,v 1.2 2004/07/01 05:31:52 simon Exp $
 *******************************************************************************
 *  $Log: Relation.java,v $
...
public abstract class Relation extends TermKey
{
    ...
    public abstract boolean isGroundLiteral();
