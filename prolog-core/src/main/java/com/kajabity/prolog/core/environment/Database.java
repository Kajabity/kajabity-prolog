...
public class Database implements PrologContext {
     ...
     *
     * @param name   the name of the stream - usually the Filename from the atom
     *               used to identify it.
     * @param stream an InputStream openned on the stream which becomes the current
     *               inpt stream.
     */
    ...
    public String toString() {
        ...
        String buf = "Database( " + relations.size() +
                " relations, " +
                operators.size() +
                " operators, " +
                functions.size() +
