...
import uk.co.williams_technologies.prolog.builtin.arithmetic.AbsFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.ArcosineFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.ArcsineFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.Arctangent2Function;
import uk.co.williams_technologies.prolog.builtin.arithmetic.ArctangentFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.CeilFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.CosFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.DegreesToRadiansFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.EulersConstant;
import uk.co.williams_technologies.prolog.builtin.arithmetic.FloatFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.FloorFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.IntegerDifferenceFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.IntegerFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.IntegerProductFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.IntegerQuotientFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.IntegerSumFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.LogicalAndFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.LogicalNegateFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.LogicalOrFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.ModulusFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.NaturalExponentFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.NaturalLogFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.NegateFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.PiConstant;
import uk.co.williams_technologies.prolog.builtin.arithmetic.PowerFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.ProductFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.QuotientFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.RadiansToDegreesFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.RandomFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.ShiftLeftFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.ShiftRightFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.SinFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.SquareRootFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.SubtractFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.SumFunction;
import uk.co.williams_technologies.prolog.builtin.arithmetic.TangentFunction;
