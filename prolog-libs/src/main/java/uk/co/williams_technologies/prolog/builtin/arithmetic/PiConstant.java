 ...
 * /home/cvs/cvs/java-prolog/src/engine/uk/co/williams_technologies/prolog/builtin/arithmetic/PiConstant.java,v
 * 1.2 2004/02/24 04:49:52 simon Exp $
 * ******************************************************************************
 * $Log: PiConstant.java,v $ Revision 1.2 2004/02/24 04:49:52 simon add standard
 * header.
 * ******************************************************************************
 */
...
public class PiConstant extends Function
{
    public PiConstant( String name, int arity )
    {
        super( name, arity );
    }
    ...
    {
        return new NumericConstant( Math.PI );
    }
}
