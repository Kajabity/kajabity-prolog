 ...
 *
 *  $Header: /home/cvs/cvs/java-prolog/src/engine/uk/co/williams_technologies/prolog/builtin/arithmetic/SumFunction.java,v 1.3 2004/05/05 05:28:38 simon Exp $
 *******************************************************************************
 *  $Log: SumFunction.java,v $
...
public class SumFunction extends Function
{
     ...
     * @param functor
     */
    public SumFunction( String name, int arity )
    {
        super( name, arity );
    }
