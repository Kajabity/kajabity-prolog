 ...
 * /home/cvs/cvs/java-prolog/src/engine/uk/co/williams_technologies/prolog/builtin/arithmetic/ShiftLeftFunction.java,v
 * 1.3 2004/05/05 05:28:38 simon Exp $
 * ******************************************************************************
 * $Log: ShiftLeftFunction.java,v $ Revision 1.3 2004/05/05 05:28:38 simon Lots
...
public class ShiftLeftFunction extends Function
{
    public ShiftLeftFunction( String name, int arity )
    {
        super( name, arity );
    }
