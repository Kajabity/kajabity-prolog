 ...
 * /home/cvs/cvs/java-prolog/src/engine/uk/co/williams_technologies/prolog/builtin/arithmetic/LogicalOrFunction.java,v
 * 1.3 2004/05/05 05:28:38 simon Exp $
 * ******************************************************************************
 * $Log: LogicalOrFunction.java,v $ Revision 1.3 2004/05/05 05:28:38 simon Lots
...
public class LogicalOrFunction extends Function
{
    public LogicalOrFunction( String name, int arity )
    {
        super( name, arity );
    }
