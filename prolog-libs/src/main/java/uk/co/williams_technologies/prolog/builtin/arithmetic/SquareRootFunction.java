 ...
 * /home/cvs/cvs/java-prolog/src/engine/uk/co/williams_technologies/prolog/builtin/arithmetic/SquareRootFunction.java,v
 * 1.3 2004/05/05 05:28:38 simon Exp $
 * ******************************************************************************
 * $Log: SquareRootFunction.java,v $ Revision 1.3 2004/05/05 05:28:38 simon Lots
...
{
    public SquareRootFunction( String name, int arity )
    {
        super( name, arity );
    }
    ...
    public NumericConstant evaluate( Stack<NumericConstant> values )
    {
        ...
        return new NumericConstant( Math.sqrt( right.doubleValue() ) );
    }
}
