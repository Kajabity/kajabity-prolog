 ...
 * /home/cvs/cvs/java-prolog/src/engine/uk/co/williams_technologies/prolog/builtin/arithmetic/LogicalNegateFunction.java,v
 * 1.3 2004/05/05 05:28:38 simon Exp $
 * ******************************************************************************
 * $Log: LogicalNegateFunction.java,v $ Revision 1.3 2004/05/05 05:28:38 simon
...
public class LogicalNegateFunction extends Function
{
    public LogicalNegateFunction( String name, int arity )
    {
        super( name, arity );
    }
    ...
    public NumericConstant evaluate( Stack<NumericConstant> values )
    {
        ...
        return new NumericConstant( ~right.longValue() );
    }
}
