 ...
 * /home/cvs/cvs/java-prolog/src/engine/uk/co/williams_technologies/prolog/builtin/arithmetic/RandomFunction.java,v
 * 1.2 2004/02/24 04:49:52 simon Exp $
 * ******************************************************************************
 * $Log: RandomFunction.java,v $ Revision 1.2 2004/02/24 04:49:52 simon add
 * standard header.
 * ******************************************************************************
 */
...
{
    public RandomFunction( String name, int arity )
    {
        super( name, arity );
    }
    ...
    {
        return new NumericConstant( (long) (Integer.MAX_VALUE * Math.random()) );
    }
}
