 ...
 */
public class ArithLessThanEqualPredicate extends GroundLiteral
{
    public ArithLessThanEqualPredicate( Database database )
    {
        super( database, "=<", 2 );
    }
     ...
     *
     * @see
     * com.kajabity.prolog.core.environment.GroundLiteral#execute(com.kajabity
     * .prolog.core.environment.PrologDatabase,
