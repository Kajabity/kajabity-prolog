 ...
 * /home/cvs/cvs/java-prolog/src/engine/uk/co/williams_technologies/prolog/builtin/arithmetic/IntegerDifferenceFunction.java,v
 * 1.3 2004/05/05 05:28:38 simon Exp $
 * ******************************************************************************
 * $Log: IntegerDifferenceFunction.java,v $ Revision 1.3 2004/05/05 05:28:38
...
public class IntegerDifferenceFunction extends Function
{
    public IntegerDifferenceFunction( String name, int arity )
    {
        super( name, arity );
    }
