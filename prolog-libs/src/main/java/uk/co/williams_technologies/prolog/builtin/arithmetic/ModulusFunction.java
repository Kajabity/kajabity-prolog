 ...
 * /home/cvs/cvs/java-prolog/src/engine/uk/co/williams_technologies/prolog/builtin/arithmetic/ModulusFunction.java,v
 * 1.3 2004/05/05 05:28:38 simon Exp $
 * ******************************************************************************
 * $Log: ModulusFunction.java,v $ Revision 1.3 2004/05/05 05:28:38 simon Lots of
...
{
    public ModulusFunction( String name, int arity )
    {
        super( name, arity );
    }
